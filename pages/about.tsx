  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Tech Blog Service is run by a team of knowledgeable tech enthusiasts who provide unbiased reviews and advice. Learn more about our experienced editors and tech experts."
        />
        <meta
          name="keywords"
          content="tech blog, tech reviews, electronics, gadgets, technology, editors, authors, writers, tech enthusiasts, experts, about us, buy a phone, Buy a laptop, best suggestion in a smartphone, best affordable price phone buy, buy gaming pc"
        />
      ...
      <div className="w-full mx-auto p-5 bg-secondaryColor/10">
        ...
        <h3 className="ml-8 text-lg">
          Tech Blog Service is dedicated to helping tech users of all experience levels get more from the hardware and software that's central to a PC-centric universe. We focus on:
          <ul>
        ...
        <p className="ml-8 text-lg mb-3">
          In compliance with the FTC guidelines, please assume the following about links and posts on Tech Blog Service.in:
        </p>
        <p className="ml-8 text-lg mb-3">
          Any/all of the links on Tech Blog Service.in are affiliate links for which I receive small compensation from sales of certain items.
        </p>
        <h2 className="text-black text-3xl font-bold m-8">What Are Affiliate Links?</h2>
        <p className="ml-8 text-lg mb-3">
          Purchases are made on external affiliate company websites: when a reader clicks on an affiliate link located on techblogservice.com to purchase an item, the reader buys the item from the seller directly (not from Tech Blog Service).
        </p>
        <p className="ml-8 text-lg mb-3">
          Amazon and/or other companies pay Tech Blog Service a small commission or other compensation for helping to bring customers to their website.
        </p>
        <p className="ml-8 text-lg mb-3">
        ...
        <p className="text-gray-600 ml-8 font-bold">Tech Blog Service uses two main types of affiliate programs:</p>
